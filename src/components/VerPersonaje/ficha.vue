  ...
  <body class="bg-gradient-to-br from-gray-50 via-white to-gray-50 p-6">
    <div id="app" class="max-w-7xl mx-auto">
      ...
      >
        ...
        <h2
          class="text-4xl font-bold text-gray-600 mb-6 pb-4 border-b border-gray-200 text-center"
        >
          {{ personaje.nombre }}
        </h2>
          ...
          <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-4 space-y-6">
              ...
              <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-3">
                <h3
                  class="text-base font-bold text-gray-700 mb-2 pb-2 border-b border-blue-300"
                >
                  Información Básica
                </h3>
                <div class="space-y-2">
                  <div class="grid grid-cols-2 gap-2">
                    <div>
                      <div
                        class="text-xs font-semibold text-blue-600 uppercase tracking-wide mb-0.5"
                      >
                        Nombre
                      </div>
              ...
              <div class="bg-blue-50 border border-blue-200 rounded-lg p-5">
                ...
                <div
                  class="max-h-120 overflow-y-auto overflow-x-visible pr-2 space-y-2"
                >
                  <div
              ...
              <div class="bg-blue-50 border border-blue-200 rounded-lg p-5">
                ...
                <div
                  class="max-h-64 overflow-y-auto overflow-x-visible pr-2 space-y-2"
                >
                  <div
            ...
            <div class="col-span-4 space-y-4">
              ...
              <div class="grid grid-cols-2 gap-3">
                <!-- HP -->
                <div
                  class="bg-gradient-to-r from-blue-100 to-blue-200 border-2 border-blue-400 text-gray-700 rounded-lg p-3 shadow-lg"
                >
                ...
                <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-2">
                  ...
                  <div class="space-y-1">
                    <div class="flex justify-between items-center text-xs px-1">
                      ...
                      <span class="font-bold text-blue-600">{{
                        personaje.agilidad.esquiva
                      }}</span>
                    </div>
                    <div class="flex justify-between items-center text-xs px-1">
                      <span class="text-gray-600">Iniciativa</span>
                      <span class="font-bold text-blue-600">{{
                        personaje.agilidad.iniciativa
                      }}</span>
                    </div>
                    <div class="flex justify-between items-center text-xs px-1">
                      <span class="text-gray-600">Deadeye</span>
                      <span class="font-bold text-blue-600">{{
                        personaje.agilidad.deadeye
                      }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="bg-blue-50 border-2 border-blue-200 rounded-lg p-2">
                  ...
                  <div class="space-y-1">
                    <div class="flex justify-between items-center text-xs px-1">
                      ...
                      <span class="font-bold text-blue-600">{{
                        personaje.mente.voluntad
                      }}</span>
                    </div>
                    <div class="flex justify-between items-center text-xs px-1">
                      <span class="text-gray-600">Pts. Hab.</span>
                      <span class="font-bold text-blue-600">{{
                        personaje.mente.puntosHabilidadRestantes
                      }}</span>
                    </div>
                  </div>
                </div>
                ...
                <div class="gap-2 mb-4">
                  ...
                  >
                    ...
                    <div class="flex justify-between text-xs text-blue-600">
                      ...
                      >
                      <span v-if="arma.distancia > 0"
                        >Dist: {{ arma.distancia }}m</span
                      >
                    </div>
                  </div>
                </div>
                ...
                <div class="max-h-[900px] overflow-y-auto pr-2 space-y-1">
                  ...
                  >
                    <div class="flex items-center gap-2">
                      <div
                        v-if="habilidad.competente"
                        class="w-4 h-4 bg-blue-500 rounded flex items-center justify-center flex-shrink-0"
                      >
                        <span class="text-white text-xs font-bold">✓</span>
                      </div>
                      <div
                        v-else
                        class="w-4 h-4 border-2 border-blue-300 rounded flex-shrink-0"
                      ></div>
...
function cargarPersonaje() {
  try {
    ...
    if (!personajeJSON) {
      console.warn(
        `No se encontró personaje guardado en localStorage con ID: ${props.characterId}`,
      );
      return;
    }
    ...
    if (datos.oficio) {
      ...
      if (oficio && datos.oficio_dotes) {
        ...
        personaje.value.dotesOficio = datos.oficio_dotes.map(
          (doteId: number) => {
    ...
    if (datos.estilo_marcial) {
      ...
      if (estilo && datos.estilo_marcial_dotes) {
        ...
        personaje.value.dotesEstilo = datos.estilo_marcial_dotes.map(
          (doteId: string) => {
            ...
            if (dote) {
              console.log(
                `Dote encontrada: ${dote.nombre} (ID: ${idNumerico})`,
              );
              return {
                nombre: dote.nombre,
                descripcion: dote.descripcion,
    ...
    if (datos.arbol) {
      try {
        ...
        nodosArbol.forEach((nodo: any) => {
          if (nodo.type === "square") {
            // Los nodos cuadrados son activas
            const activa = activasData.activas.find(
              (a) => a.id === parseInt(nodo.nodeId),
            );
            if (activa) {
