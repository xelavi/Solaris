...
export function useCharacterCreation() {
  ...
  watch(() => characterData.value.nivel, () => {
    recalcularAtributos()
    saveCharacterData()
  })
  ...
  watch(() => characterData.value.oficio_dotes, () => saveCharacterData(), { deep: true })
  ...
  watch(() => characterData.value.trasfondo, () => {
    recalcularAtributos()
    saveCharacterData()
  })
  ...
  watch(() => characterData.value.arbol, () => {
    recalcularAtributos()
    saveCharacterData()
  })
  watch(() => characterData.value.armas, () => saveCharacterData(), { deep: true })
